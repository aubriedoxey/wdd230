...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5351428&appid=9fa85cce9ff44eb89eb0511a9301b64f";
const getWeather = async () => {
    ...
    document.querySelector('#ws').textContent = (jsObject.wind.speed*2).toFixed(2);
